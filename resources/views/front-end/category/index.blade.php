                    ...
                    <div class="product-sidebar">
                        ...
                        <div class="single-widget">
                            ...
                            <ul class="list">
                                ...
                                <li>
                                    <a href="{{route('product-category', ['id' => $category->id])}}">{{$category->name}}</a><span>(1138)</span>
                                </li>
                                @endforeach
                            </ul>
                        </div>
                                    ...
                                    <div class="col-lg-4 col-md-6 col-12">
                                        ...
                                        <div class="single-product">
                                            ...
                                            <div class="product-info">
                                                ...
                                                <div class="price">
                                                    <span class="me-3"><del>Price{{$product->regular_price}}</del>tk</span>
                                                    <span>Discount Price{{$product->selling_price}} tk</span>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-12">
                                        ...
                                        <div class="single-product">
                                            <div class="row align-items-center">
                                                <div class="col-lg-4 col-md-4 col-12">
                                                    <div class="product-image">
                                                        <img src="{{ asset('/') }}front-end-assets/assets/images/products/product-2.jpg" alt="#">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-12">
                                        ...
                                        <div class="single-product">
                                            <div class="row align-items-center">
                                                <div class="col-lg-4 col-md-4 col-12">
                                                    <div class="product-image">
                                                        <img src="{{ asset('/') }}front-end-assets/assets/images/products/product-4.jpg" alt="#">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-12">
                                        ...
                                        <div class="single-product">
                                            <div class="row align-items-center">
                                                <div class="col-lg-4 col-md-4 col-12">
                                                    <div class="product-image">
                                                        <img src="{{ asset('/') }}front-end-assets/assets/images/products/product-7.jpg" alt="#">
